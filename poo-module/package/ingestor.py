...
class DaySummaryIngestor(DataIngestor):
    ...
    def get_writer(self, api, currency, date):
        return self.writer(f'{api.__class__.__name__}/{currency}/{date.strftime(self.DATE_FORMAT)}.json')
...
class TradeIngestor(DataIngestor):
    ...
    def get_writer(self, currency, date_from, date_to):
        return self.writer(f'{self.api.__class__.__name__}/{currency}/{date_from.strftime(self.DATE_FORMAT)}.json')
